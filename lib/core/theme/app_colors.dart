...
abstract class AppColors {
  static const primarySwatch = Color.fromRGBO(4, 164, 132, 1);
  static const primaryVariation = Color.fromRGBO(89, 191, 169, 1);

  static const background = Color.fromRGBO(26, 26, 26, 1);
